export const OVERCOOKED_26_TABLES = {
  ...
  groupOrders: "overcooked_26_group_orders",
  cookingSessions: "overcooked_26_cooking_sessions",
  servedOrders: "overcooked_26_served_orders",
  gameEvents: "overcooked_26_game_events",
} as const;
